...
Single source of truth. Scoring reads from here; the cover-letter engine will too.
Edit this file rather than sprinkling candidate facts through the codebase.
"""
